  ...
  return (
    <nav className="w-full flex items-center justify-between bg-transparent flex-col z-50 fixed top-0 left-0">
      <div className="bg-[#1f8f69] py-2 sm:py-3 w-full min-h-10 px-4 sm:px-6 md:px-12 lg:px-24 flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-2 sm:gap-4 mb-2 sm:mb-0">
          <div className="text-white font-medium flex items-center">
            <Image src={Dot} alt="" width={8} height={8} className="w-2 h-2 mr-1" />
        ...
        <div className="flex flex-row space-x-3 sm:space-x-4">
          <a href="#" aria-label="Facebook" className="text-white hover:text-[#e5c464] transition-colors">
            <Image src={Facebook} alt="Facebook" width={16} height={16} className="w-4 h-4" />
          </a>
          <a href="#" aria-label="Twitter" className="text-white hover:text-[#e5c464] transition-colors">
            <Image src={Twitter} alt="Twitter" width={16} height={16} className="w-4 h-4" />
          </a>
          <a href="#" aria-label="Instagram" className="text-white hover:text-[#e5c464] transition-colors">
            <Image src={Instagram} alt="Instagram" width={16} height={16} className="w-4 h-4" />
          </a>
          <a href="#" aria-label="Behance" className="text-white hover:text-[#e5c464] transition-colors">
            <Image src={Behance} alt="Behance" width={16} height={16} className="w-4 h-4" />
          </a>
        </div>
      </div>
      <div className="h-16 md:h-20 lg:h-24 w-full relative overflow-hidden">
        ...
        <div className={`md:hidden fixed inset-0 z-20 transition-all duration-300 ease-in-out ${
          ...
          >
            <div className="h-full flex flex-col pt-20 px-6 overflow-y-auto">
              ...
              <div className="flex items-center mb-12 px-2">
                ...
                <span className="ml-2 text-2xl font-bold text-white">Fixyland</span>
              </div>
        ...
        <div className={`relative z-10 flex flex-row justify-between w-full h-full px-4 sm:px-6 md:pr-12 lg:pr-24 items-center transition-all duration-300 ${
          scrolled ? 'bg-white/90 backdrop-blur-sm' : ''
        }`}>
          {/* Logo */}
          <Link href="/" className="flex items-center h-full">
            <div className={`w-36 sm:w-48 lg:w-56 h-full flex font-bold text-xl md:text-2xl lg:text-3xl justify-center text-center items-center clip-diagonal ${
              scrolled ? 'bg-white' : 'bg-white'
            } text-black px-4`}>
              <Image src={Logo} alt="Fixyland Logo" width={40} height={40} className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10" />
              <span className="ml-1 sm:ml-2">Fixyland</span>
            </div>
          </Link>
          
          {/* Desktop Navigation */}
          <div className={`hidden md:flex flex-row flex-1 justify-center items-center ${
            scrolled ? 'text-gray-800' : 'text-white'
          }`}>
            <div className="flex space-x-1 lg:space-x-2 xl:space-x-4 mx-4">
              {['Home', 'Rooms', 'Services', 'About', 'Blog', 'Contact'].map((item) => (
                <Link 
                  key={item} 
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
            <button className="bg-[#545047] hover:bg-[#3d3a33] p-2 rounded-full transition-colors">
              <Image src={Search} alt="Search" width={24} height={24} className="w-4 h-4 md:w-5 md:h-5" />
            </button>
            <Button 
              text="Book Now" 
              color="#e5c464" 
          ...
          <div className="md:hidden flex items-center space-x-2">
            <button className="bg-[#545047] hover:bg-[#3d3a33] p-2 rounded-full">
              <Image src={Search} alt="Search" width={20} height={20} className="w-4 h-4" />
            </button>
            <Button 
              text="Book" 
              color="#e5c464" 
