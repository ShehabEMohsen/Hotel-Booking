    ...
    <section className="bg-[#181A1B] pt-0 h-[80vh]">
      <div className="relative flex w-full h-64 md:h-72 lg:h-80 xl:h-96 overflow-hidden">
        {[room1, room2, room3, room4, room5].map((img, i) => (
          <div key={i} className="flex-1 relative h-full">
            <Image src={img} alt="room" fill className="object-cover w-full h-full" />
          </div>
        ))}
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
          <div className="bg-white/80 rounded-xl w-88 h-88 px-8 py-6 flex flex-col justify-center items-center shadow-lg">
            ...
            <div className="text-[#1f8f69] font-bold text-4xl">Follow Our<br/>Instagram</div>
          </div>
        </div>
      </div>
      <div className="w-full px-6 md:px-16 xl:px-32 2xl:px-64 pt-12 pb-8 bg-[#181A1B] grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        <div className="flex flex-col gap-6">
          ...
          <div className="text-gray-400 text-sm">Nam libero tempore cum soluta nobis est eligendi optio cumque nihil impedit quo minus maxime placeat facere</div>
          <div className="flex gap-3 mt-2">
            <a href="#" className="bg-[#232627] p-2 rounded-md"><Image src={Facebook} alt="fb" className="w-5 h-5" /></a>
            <a href="#" className="bg-[#232627] p-2 rounded-md"><Image src={Twitter} alt="ig" className="w-5 h-5" /></a>
            <a href="#" className="bg-[#232627] p-2 rounded-md"><Image src={InstagramWhite} alt="tw" className="w-5 h-5" /></a>
            <a href="#" className="bg-[#232627] p-2 rounded-md"><Image src={Behance} alt="be" className="w-5 h-5" /></a>
          </div>
        </div>
        <div className="flex flex-col gap-3">
          <div className="text-white font-bold text-2xl mb-2">EXPLORE</div>
          <a href="#" className="text-gray-400 hover:text-white text-sm">About Hotel</a>
          <a href="#" className="text-gray-400 hover:text-white text-sm">Pricing</a>
          <a href="#" className="text-gray-400 hover:text-white text-sm">Hotel Staff</a>
          <a href="#" className="text-gray-400 hover:text-white text-sm">Latest News</a>
        ...
        <div className="flex flex-col gap-3 w-1/2">
          ...
          <div className="text-gray-400 text-sm">1963 Sabrina Path, T15 Domain Isle, Louisiana, USA</div>
        ...
        <div className="flex flex-col gap-4 bg-[#232323] p-8 rounded-xl w-96">
          ...
          <form className="flex flex-col gap-3">
            <div className="relative">
              <input type="email" placeholder="Ex. info@domain.com" className="w-full pl-4 pr-12 py-2 rounded-md bg-transparent border-white border-b-2 text-gray-200 placeholder-gray-500 outline-none" />
            ...
            <label className="flex items-center gap-2 text-gray-400 text-xs">
              <input type="checkbox" className="accent-[#1f8f69] " />
